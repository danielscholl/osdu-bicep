...
module queue_authorizationRules 'queue_authorization_rules.bicep' = [for (authorizationRule, index) in authorizationRules: {
...
module queue_roleAssignments './queue_nested_rbac.bicep' = [for (roleAssignment, index) in roleAssignments: {
  name: '${deployment().name}-Rbac-${index}'
  params: {
    description: contains(roleAssignment, 'description') ? roleAssignment.description : ''
    principals: roleAssignment.principalIds
