...
module topic_authorizationRules 'topic_authorization_rules.bicep' = [for (authorizationRule, index) in authorizationRules: {
...
module topic_roleAssignments 'topic_nested_rbac.bicep' = [for (roleAssignment, index) in roleAssignments: {
